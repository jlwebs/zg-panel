    ...
    return (
        ...
        >
            ...
            <AccountRowContent
                ...
                isIDECurrent={isIDECurrent}
                onApplyToIDE={onApplyToIDE}
            />
        </tr>
    );
}
            ...
            <td className="px-2 py-1 align-middle">
                <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                        ...
                        {isIDECurrent && (
                            <span className="px-2 py-0.5 rounded-md bg-emerald-100 dark:bg-emerald-900/50 text-emerald-700 dark:text-emerald-300 text-[10px] font-bold flex items-center gap-1 shadow-sm border border-emerald-200/50 dark:border-emerald-800/50">
                    ...
                    {onApplyToIDE && (
                        <button
                            className={cn(
                                "p-1.5 rounded-lg transition-all",
                                isIDECurrent
                                    ? "text-emerald-600 bg-emerald-50 dark:text-emerald-400 dark:bg-emerald-900/10"
                                    : "text-gray-500 dark:text-gray-400 hover:text-emerald-600 dark:hover:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/30"
                            )}
